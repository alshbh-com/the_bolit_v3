...
export const ALL_SECTIONS = [
  ...
  { key: 'courier-closing', label: 'التقفيل اليومي', url: '/courier-closing' },
  { key: 'closings-archive', label: 'أرشيف التقفيلات', url: '/closings-archive' },
  { key: 'treasury', label: 'الخزنة', url: '/treasury' },
  { key: 'courier-statement', label: 'كشف حساب المندوب', url: '/courier-statement' },
